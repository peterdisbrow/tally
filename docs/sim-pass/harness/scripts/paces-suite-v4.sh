...
run v4-src-e2e-1 e2e-electron.mjs
run v4-src-e2e-2 e2e-electron.mjs
run v4-src-hard paces-e2e.mjs "" stop
run v4-appimage-e2e e2e-electron.mjs /tmp/paces-appimage/squashfs-root/tally-connect
run v4-appimage-hard paces-e2e.mjs /tmp/paces-appimage/squashfs-root/tally-connect kill
run v4-deb-e2e e2e-electron.mjs /tmp/paces-deb/opt/Tally/tally-connect
run v4-deb-hard paces-e2e.mjs /tmp/paces-deb/opt/Tally/tally-connect stop
bash scripts/cleanup-tally.sh
echo SUITE_DONE
