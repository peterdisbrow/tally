  ...
  <div class="content" id="content">
    ...
    <div id="page-churches" style="display:none">
      ...
      <table id="churches-table">
        <thead><tr>
          <th class="sortable" onclick="sortTable('churches','name',this)">Name</th><th>Reseller</th><th class="sortable" onclick="sortTable('churches','connected',this)">Status</th><th>Type</th><th>Rooms</th><th>Registered</th><th class="sortable" onclick="sortTable('churches','lastSeen',this)">Last Seen</th><th>Actions</th>
        </tr></thead>
    ...
    <div id="page-alerts" style="display:none">
      ...
      <table id="alerts-table">
        <thead><tr>
          <th class="sortable" onclick="sortTable('alerts','created_at',this)">Time</th><th class="sortable" onclick="sortTable('alerts','church_name',this)">Church</th><th>Room</th><th>Type</th><th class="sortable" onclick="sortTable('alerts','severity',this)">Severity</th><th>Status</th><th>Actions</th>
        </tr></thead>
...
// ─── Navigation ───────────────────────────────────────────────────────────────
const allPages = ['overview','onboarding','churches','resellers','alerts','tickets','billing','aiusage','emails','streams','auditlog','settings'];
function showPage(page) {
  ...
  const titles = {overview:'Overview',onboarding:'Onboarding',churches:'Churches',resellers:'Resellers',alerts:'Alerts',tickets:'Tickets',billing:'Billing',aiusage:'AI Usage',emails:'Emails',streams:'Stream Preview',auditlog:'Audit Log',settings:'Settings'};
