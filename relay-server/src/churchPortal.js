  ...
  <main class="main">
    ...
    <div class="page" id="page-tds">
      ...
      <div class="card">
        ...
        <div class="table-wrap">
        <table>
          <thead><tr><th>Name</th><th><span class="tip" data-tip="Job title or role in the tech team">Role</span></th><th><span class="tip" data-tip="Controls what this person can do in Tally via Telegram: viewer=status only, operator=control switcher, admin=full access">Access</span></th><th>Email</th><th></th></tr></thead>
          <tbody id="tds-tbody">
            <tr><td colspan="5" style="color:#475569;text-align:center;padding:20px">Loading…</td></tr>
          </tbody>
        </table>
