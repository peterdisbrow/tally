...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  fetchRoomEquipment: (roomId) => ipcRenderer.invoke('fetch-room-equipment', { roomId }),
  validateToken: () => ipcRenderer.invoke('validate-token'),
  prepareForLogin: (newToken) => ipcRenderer.invoke('prepare-for-login', { newToken }),
  ...
  autoRejoinRoom: () => ipcRenderer.invoke('auto-rejoin-room'),
  leaveRoom: () => ipcRenderer.invoke('leave-room'),
  onRejoinConfirmed: (cb) => ipcRenderer.on('rejoin-confirmed', (_, data) => cb(data)),
  onRejoinFailed: (cb) => ipcRenderer.on('rejoin-failed', (_, data) => cb(data)),
